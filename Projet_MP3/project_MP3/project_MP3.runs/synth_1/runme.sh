...
HD_PWD='C:/Users/malau/Documents/GitHub/processeur/Projet_MP3/project_MP3/project_MP3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interface_utilisateur.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interface_utilisateur.tcl
