...
HD_PWD='C:/Users/malau/Documents/GitHub/processeur/Projet_MP3/project_MP3/project_MP3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interface_utilisateur.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interface_utilisateur.tcl -notrace
